...
vim.keymap.set('n', '<leader>fy', util.get_relative_path_from_git_root, { desc = 'Yank Git-Relative Path To Clipboard' }) -- copy git-relative path to clipboard
...
-- NOTE: disabling for now for compat with lazygit
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sx', builtin.resume, { desc = 'Resume' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gi', require('telescope.builtin').lsp_implementations, '[G]oto [I]mplementation') -- replacing 'gi' for go to last insert.
      ...
      local servers = {
        ...
        -- pyright = {},
        -- rust_analyzer = {}, -- disablin this due to rustaceanvim controlling the LSP
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      cmp.setup {
        ...
        completion = { completeopt = 'menu,menuone,noselect' }, -- dropping the noinsert fixes godot lsp for some reason?
